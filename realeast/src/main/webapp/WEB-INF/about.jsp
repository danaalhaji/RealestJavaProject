            ...
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">Dana Al-Haji</h3></div>
              </div>
              <div class="card-body-d">
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong>+972595130015</p>
                  <p>
                    <strong>Email: </strong> dana.alhaji95@gmail.com</p>
                </div>
              </div>
          ...
          <div class="card-box-d">
            ...
            <div class="card-overlay card-overlay-hover">
              ...
              <div class="card-body-d">
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +972597526385</p>
                  <p>
                    <strong>Email: </strong> ameer.r.baghdadi@gmail</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
          ...
          <div class="card-box-d">
            ...
            <div class="card-overlay card-overlay-hover">
              ...
              <div class="card-body-d">
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> 45484848484</p>
                  <p>
                    <strong>Email: </strong>b.aboasal@gmail.com</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
          ...
          <div class="card-box-d">
            ...
            <div class="card-overlay card-overlay-hover">
              ...
              <div class="card-body-d">
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong>+972598035349</p>
                  <p>
                    <strong>Email: </strong> mostafa.hajqasem@gmail</p>
                </div>
              </div>
              <div class="card-footer-d">
                <div class="socials-footer d-flex justify-content-center">
